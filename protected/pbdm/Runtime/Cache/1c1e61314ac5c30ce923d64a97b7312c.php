<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
        ...
        <head>
            <meta charset="utf-8">
            <title>Welcome to WWW.PBDM.CC</title>
            ...
            <!--[if IE 7]>
            <link rel="stylesheet" href="../publicassets/css/font-awesome-ie7.min.css">
            <![endif]-->
            <!--[if lt IE 9]>
            <link rel="stylesheet" type="text/css" href="../publiccss/custom-theme/jquery.ui.1.10.0.ie.css"/>
            <![endif]-->
            ...
            <link rel="shortcut icon" href="../publicassets/ico/favicon.png">
        ...
        <footer class="footer">
            <div class="container">
                 <p>This document was written by <a href="mailto:g@pbdm.cc">Amber</a> ©2012</p>
            </div>
        </footer>
